...
C:\Python27\Scripts\pyside-uic.exe E:\user\atri\AssetBrowser\AssetBrowser\AssetBrowser\UI\addCategory.ui -o E:\user\atri\AssetBrowser\AssetBrowser\AssetBrowser\addCategoryUI.py
C:\Python27\Scripts\pyside-uic.exe E:\user\atri\AssetBrowser\AssetBrowser\AssetBrowser\UI\addAssetWindow.ui -o E:\user\atri\AssetBrowser\AssetBrowser\AssetBrowser\addAssetWindowUI.py
